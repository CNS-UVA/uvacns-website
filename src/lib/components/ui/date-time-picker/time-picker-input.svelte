...
<Input
	...
	name={name || picker}
	class={cn(
		'focus:bg-accent focus:text-accent-foreground w-[48px] text-center font-sans text-base tabular-nums caret-transparent [&::-webkit-inner-spin-button]:appearance-none',
		className
	)}
